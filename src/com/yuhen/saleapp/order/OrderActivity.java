...
public class OrderActivity extends FragmentActivity {
	...
	private RadioButton rbtnRadio0;
	private RadioButton rbtnRadio1;
	private RadioButton rbtnRadio2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		initView();
		head_center_text.setText("我的订单");
		sessionManager = new SessionManager(getApplicationContext());
		
		/** 选项卡  **/
		
		mRadioGroup = (RadioGroup) findViewById(R.id.radioGroup1);
		rbtnRadio0 = (RadioButton)findViewById(R.id.radio0);
		rbtnRadio0.setText("进行中");
		
		rbtnRadio1 = (RadioButton)findViewById(R.id.radio1);
		rbtnRadio1.setText("已完成");
		
		rbtnRadio2 = (RadioButton)findViewById(R.id.radio2);
		rbtnRadio2.setVisibility(RadioButton.GONE);
		...
		/** 具体内容  **/
		mViewPager = (ViewPager) findViewById(R.id.vp_order_list);
