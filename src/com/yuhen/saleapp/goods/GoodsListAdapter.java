...
public class GoodsListAdapter extends BaseAdapter {
	...
	public GoodsListAdapter(Activity context, List<MerchInfo> items) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(this.context).inflate(R.layout.custom_goods_list_view, null);
