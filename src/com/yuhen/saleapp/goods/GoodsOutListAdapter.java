...
public class GoodsOutListAdapter extends BaseAdapter {
	...
	public GoodsOutListAdapter(Activity context, List<MerchInfo> items) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = LayoutInflater.from(this.context).inflate(R.layout.custom_goods_out_list_view, null);
			...
			holder.btnPreview = (Button)convertView.findViewById(R.id.btn_preview);
