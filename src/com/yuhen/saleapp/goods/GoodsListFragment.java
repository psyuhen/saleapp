...
public class GoodsListFragment extends Fragment {
	...
	public GoodsListFragment(Context context) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View contentView = inflater.inflate(R.layout.view_goods_lists,
				container, false);
		listView = (ListView) contentView.findViewById(R.id.lv_goods_list);
		...
		try {
			...
			requestParams.setOut_published("0");//出售中
			...
			if(jsonResult != null){
				...
				goodsListAdapter = new GoodsListAdapter(getActivity(), items);
