...
public class TitlePopup extends PopupWindow {
	...
	// 弹窗子类项选中时的监听
	private OnItemOnClickListener menuItemOnClickListener;
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int index, long arg3) {
				...
				if (menuItemOnClickListener != null)
					menuItemOnClickListener.onItemClick(mActionItems.get(index), index);
				// 点击子类项后，弹窗消失
				dismiss();
	...
	// 只是一个提示作用
	protected void myShowDialog(String mesg, Context mContext) {
	 ...
	 * 设置监听事件
	 */
	public void setMenuItemOnClickListener(OnItemOnClickListener onItemOnClickListener) {
		this.menuItemOnClickListener = onItemOnClickListener;
	}
